...
À l'issue de cette conférence, vous saurez:
- Identifier les différents types de biais algorithmiques
- Détecter et atténuer les biais dans vos projets IA
...
#### Exercice interactif: Spot the Bias
...
- **Niveau d'éducation** = peut pénaliser auto-entrepreneurs
- **Historique bancaire** = exclut non-bancarisés (majoritairement femmes rurales)
...
### Détecter et atténuer les biais
...
## PARTIE 2: SÉCURITÉ DES DONNÉES

### Enjeux de sécurité avec l'IA
...
## PARTIE 3: RESPECT DE LA VIE PRIVÉE
